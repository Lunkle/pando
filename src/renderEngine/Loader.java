...
public class Loader {
	...
	public static int loadCube(String[] textureFiles) {
		// These texture files must be ordered like so:
		...
		for (int i = 0; i < textureFiles.length; i++) {
			...
			GL11.glTexImage2D(GL13.GL_TEXTURE_CUBE_MAP_POSITIVE_X + i, 0, GL11.GL_RGBA, data.getWidth(), data.getWidth(), 0, GL11.GL_RGBA, GL11.GL_UNSIGNED_BYTE, data.getBuffer());
		}
